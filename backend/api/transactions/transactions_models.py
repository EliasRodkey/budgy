...
class TransactionFilters:
    ...
    tags: Optional[str] = None # OR logic: match any of these tags, Will be comma seperated, must parse
    show_excluded: Optional[bool] = False # default false — excluded transactions are hidden
